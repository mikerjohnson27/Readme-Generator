...
function generateMarkdown(data) {
  ...
  GitHub Usernames: [${data.username}](#https://github.com/${data.username})

  Emails: [${data.email}](#mailto:${data.email})


  ## License

  ![AMP](https://img.shields.io/badge/License-${data.license}-blue)
